...
const ServiceToInvoiceCreate = () => {
  ...
  const loadServiceData = useCallback(async (id: string) => {
    console.log("🔵 [ServiceToInvoiceCreate] Loading service data...", { serviceId: id });
    try {
      setLoadingData(true);
      setError(null);
      ...
      console.log("✅ [ServiceToInvoiceCreate] Service data loaded successfully", { 
        serviceId: service.id,
        itemsCount: invoiceItems.length 
      });
    } catch (error) {
      console.error("❌ [ServiceToInvoiceCreate] Error loading service:", error);
  ...
  const handleSave = async () => {
    console.log("💾 [ServiceToInvoiceCreate] Saving invoice...");
    try {
      // Validation
      ...
      console.log("✅ [ServiceToInvoiceCreate] Invoice saved successfully", { invoiceId: invoice.id });
      
      toast.success("Fatura başarıyla oluşturuldu");
      navigate(`/sales-invoices/${invoice.id}`);

    } catch (error) {
      console.error('❌ [ServiceToInvoiceCreate] Error saving invoice:', error);
