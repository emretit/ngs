...
const EnhancedBudgetMatrix = ({ 
                  ...
                  <>
                    ...
                    {cell.budget_amount > 0 && (
                      <Badge
                        variant="outline"
                        className={cn(
                          "text-[9px] px-1 py-0 mt-0.5 flex items-center justify-center gap-0.5 border",
      ...
      <TooltipProvider>
        <Tooltip>
          <TooltipTrigger asChild>
            <div
              className={cn(
                "text-center py-1 px-1 rounded transition-colors",
  ...
  const displayRows = showSubcategories 
    ? matrixRows 
      ...
      <div className="bg-gradient-to-r from-slate-50 to-white border-b border-slate-200/60 p-4">
        <div className="flex items-center justify-between">
          <div className="flex items-center gap-2.5">
            <div className="p-2 bg-gradient-to-br from-purple-500 to-purple-600 rounded-lg shadow-md text-white">
            ...
            <TableRow className="hover:bg-transparent">
              ...
              {MONTHS_SHORT.map((month, index) => (
                <TableHead
                  key={index}
                  className={cn(
                    "text-center w-[110px] font-medium text-xs text-slate-700 py-2 px-1 border-r border-slate-200/50",
              ...
              <TableHead className="text-center w-[110px] font-semibold text-xs text-slate-900 bg-slate-100/50 py-2 px-1 border-r border-slate-200">
                Toplam
              </TableHead>
              <TableHead className="text-center w-[110px] font-semibold text-xs text-slate-900 bg-slate-100/50 py-2 px-1">
                YTD
              </TableHead>
            </TableRow>
          </TableHeader>
                  ...
                  >
                    {row.isSubcategory ? (
                      ...
                      <button
                        ...
                        className={cn(
                          "flex items-center gap-2 transition-colors w-full text-left group",
                      ...
                      <>
                        ...
                        {row.total.budget_amount > 0 && (
                          <Badge
                            variant="outline"
                            className={cn(
                              "text-[9px] px-1 py-0 mt-0.5 inline-flex items-center gap-0.5 border",
