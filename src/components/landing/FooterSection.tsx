...
const FooterSection = () => {
  ...
  return (
    <footer id="contact" className="scroll-mt-20 relative py-16 px-4 sm:px-6 lg:px-8">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-5 gap-8 mb-12">
          ...
          <div className="lg:col-span-2">
            ...
            <div className="space-y-3">
              <div className="flex items-center space-x-2 text-gray-300 group cursor-pointer">
                ...
                <span className="text-sm group-hover:text-red-400 transition-colors duration-300">{t("landing.footer.email")}</span>
              </div>
              <div className="flex items-center space-x-2 text-gray-300 group cursor-pointer">
                <div className="w-2 h-2 bg-red-500 rounded-full group-hover:scale-125 transition-transform duration-300"></div>
                <span className="text-sm group-hover:text-red-400 transition-colors duration-300">{t("landing.footer.phone")}</span>
              </div>
            </div>
          </div>
          ...
          <div>
            <h3 className="text-base font-bold text-white mb-5 relative">
              ...
              <div className="absolute -bottom-1.5 left-0 w-6 h-0.5 bg-gradient-to-r from-red-500 to-red-600 rounded-full"></div>
            </h3>
            <ul className="space-y-3">
              <li><a href="#modules" className="text-gray-300 hover:text-red-400 transition-all duration-300 text-sm group flex items-center">
                <span className="w-1 h-1 bg-red-500 rounded-full mr-2 group-hover:scale-150 transition-transform duration-300"></span>
                {t("landing.footer.modules")}
              </a></li>
              <li><a href="#pricing" className="text-gray-300 hover:text-red-400 transition-all duration-300 text-sm group flex items-center">
                <span className="w-1 h-1 bg-red-500 rounded-full mr-2 group-hover:scale-150 transition-transform duration-300"></span>
                {t("landing.footer.pricing")}
              </a></li>
              <li><a href="#" className="text-gray-300 hover:text-red-400 transition-all duration-300 text-sm group flex items-center">
                <span className="w-1 h-1 bg-red-500 rounded-full mr-2 group-hover:scale-150 transition-transform duration-300"></span>
          ...
          <div>
            ...
            <ul className="space-y-3">
              ...
              <li><a href="#contact" className="text-gray-300 hover:text-red-400 transition-all duration-300 text-sm group flex items-center">
                <span className="w-1 h-1 bg-red-500 rounded-full mr-2 group-hover:scale-150 transition-transform duration-300"></span>
                {t("landing.footer.contact")}
              </a></li>
              <li><a href="#faq" className="text-gray-300 hover:text-red-400 transition-all duration-300 text-sm group flex items-center">
                <span className="w-1 h-1 bg-red-500 rounded-full mr-2 group-hover:scale-150 transition-transform duration-300"></span>
        ...
        <div className="border-t border-gray-700/30 pt-8">
          <div className="flex flex-col lg:flex-row justify-between items-center space-y-4 lg:space-y-0">
            <div className="text-center lg:text-left">
              ...
              <div className="flex items-center justify-center lg:justify-start space-x-4 text-[11px] text-gray-500">
            ...
            <div className="flex items-center space-x-4">
              <a href="#" className="text-gray-400 hover:text-red-400 transition-all duration-300 group">
                <div className="p-2 rounded-full bg-gray-800/50 group-hover:bg-red-500/10 group-hover:scale-110 transition-all duration-300">
