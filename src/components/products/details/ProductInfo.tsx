        ...
        <div className="px-3 pb-3 pt-3">
          <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-3">
            ...
            <div className="space-y-0.5">
              ...
              <div className="text-xs font-medium text-gray-900 truncate">
                {formatCurrency(product.price, product.currency || 'TL')}
              </div>
            </div>
            ...
            <div className="space-y-0.5">
              ...
              <div className="text-xs font-medium text-gray-900 truncate">
                {product.purchase_price ? formatCurrency(product.purchase_price, product.currency || 'TL') : <span className="text-gray-400 italic">Belirtilmemiş</span>}
              </div>
            </div>
            ...
            <div className="space-y-0.5">
              ...
              <div className="text-xs font-medium text-gray-900 truncate">
                {product.currency === 'TL' ? 'TL' : product.currency || 'TL'}
              </div>
            </div>
