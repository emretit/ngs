...
import { Plus, ShoppingCart, TrendingUp, Clock, DollarSign } from "lucide-react";
...
const PurchaseInvoicesHeader = ({
  ...
  // Toplam tutar hesapla (sadece normal purchase invoices için, diğerlerinin tutarları farklı field'larda olabilir)
        ...
        <div className="flex items-center gap-3">
          ...
          <div className="space-y-0.5">
            ...
            <p className="text-xs text-muted-foreground/70">
              Alış faturalarınızı yönetin ve takip edin.
            </p>
          </div>
        </div>
