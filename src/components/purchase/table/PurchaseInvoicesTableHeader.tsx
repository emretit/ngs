...
interface PurchaseInvoicesTableHeaderProps {
  columns: Column[];
  sortField: string;
...
const PurchaseInvoicesTableHeader = ({
  columns,
  sortField,
  sortDirection,
  onSort,
  ...
  onSelectAll,
  isAllSelected
}: PurchaseInvoicesTableHeaderProps) => {
        ...
        {columns.map((column) => (
          <TableHead
            ...
            className={cn(
              ...
              column.id === 'tarih' || column.id === 'tutar' || column.id === 'durum' || column.id === 'tip' ? "text-center" : "text-left",
...
export default PurchaseInvoicesTableHeader;
