/**
 * ReportDrillDownModal Component
 * Rapor detaylarını gösterir (tablo formatında)
 */
...
import type { DrillDownData } from "@/types/salesReports";
...
export default function ReportDrillDownModal({
  open,
  onClose,
  data,
