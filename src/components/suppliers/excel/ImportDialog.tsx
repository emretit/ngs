...
import { useSupplierExcelImport } from '@/hooks/useSupplierExcelImport';
...
const SupplierImportDialog = ({ isOpen, setIsOpen, onImportSuccess }: SupplierImportDialogProps) => {
  const {
    isLoading,
    selectedFile,
    progress,
    ...
    handleMappingCancel
  } = useSupplierExcelImport(() => {
    setIsOpen(false);
    if (onImportSuccess) onImportSuccess();
  });
  
  const systemFields = [
    { value: 'name', label: 'Tedarikçi Adı (zorunlu)' },
    ...
    { value: 'bank_name', label: 'Banka Adı' },
  ...
  return (
    <Dialog open={isOpen} onOpenChange={setIsOpen}>
      <DialogContent className="max-w-4xl max-h-[90vh] overflow-y-auto">
        <DialogHeader>
          <DialogTitle>Excel Dosyasından Tedarikçi İçe Aktar</DialogTitle>
        </DialogHeader>
            ...
            <div className="flex items-start space-x-2">
              ...
              <div className="space-y-2 text-sm text-blue-700">
                ...
                <div className="grid grid-cols-2 gap-x-4 gap-y-1">
                  ...
                  <div>Web Sitesi (isteğe bağlı)</div>
                  <div>Banka Adı (isteğe bağlı)</div>
                  <div>IBAN (isteğe bağlı)</div>
                </div>
                <p className="mt-2">
            ...
            <div className="flex items-start space-x-2">
              ...
              <div className="text-sm text-amber-700">
                ...
                <ul className="list-disc list-inside space-y-1">
                  <li>Sistem, aynı isme sahip tedarikçileri kontrol edecek</li>
                  <li>Mevcut tedarikçiler mükerrer olarak işaretlenecek</li>
                  <li>Sadece yeni tedarikçiler eklenecektir</li>
                          ...
                          <div className="flex items-start space-x-2">
                            ...
                            <div className="flex-1">
                              ...
                              <p className="text-xs text-red-700">
                                {missingLabels.join(', ')} - Bu alanlar olmadan tedarikçi oluşturulamaz. Lütfen Excel dosyanızda bu kolonları ekleyin veya eşleştirin.
                              </p>
                            </div>
                          </div>
                        </div>
