        ...
        <CardContent className="space-y-3 pt-4 px-4 pb-4">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-3">
            <div className="space-y-1.5">
              <Label htmlFor="type" className="text-xs font-medium text-gray-700">Tedarikçi Tipi *</Label>
              <Select
                value={formData.type}
              ...
              >
                <SelectTrigger id="type" className="h-7 text-xs">
                  <SelectValue placeholder="Tedarikçi tipini seçiniz" />
                </SelectTrigger>
                <SelectContent>
            ...
            <div className="space-y-1.5">
              <Label htmlFor="status" className="text-xs font-medium text-gray-700">Tedarikçi Durumu *</Label>
              <Select
