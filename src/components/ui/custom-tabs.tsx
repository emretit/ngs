...
>(({ className, ...props }, ref) => (
  <TabsPrimitive.List
    ref={ref}
    className={cn(
      "inline-flex h-12 items-center justify-start sm:justify-center rounded-lg bg-white/80 p-1 shadow-sm backdrop-blur-sm border border-gray-100 overflow-x-auto scrollbar-hide gap-1",
      className
    )}
    {...props}
  />
