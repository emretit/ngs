...
// Payment Accounts Hooks - React Query ile optimize edilmiş
interface PaymentAccount {
  id: string;
  label: string;
}

// Cash Accounts için payment hook
...
// Bank Accounts için payment hook
...
// Credit Cards için payment hook
...
// Partner Accounts için payment hook
...
// Tüm payment accounts'u birleştiren hook
