...
const BankAccountDetail = ({ isCollapsed, setIsCollapsed }: BankAccountDetailProps) => {
  ...
  const { data: transactions = [], isLoading: isLoadingTransactions, refetch: refetchTransactions } = useBankAccountTransactions(id);
    ...
    <div className="p-6">
        ...
        <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-3 p-3 pl-12 bg-white rounded-md border border-gray-200 shadow-sm">
          ...
          <div className="flex items-center gap-3">
            ...
            <div className="p-2 bg-gradient-to-r from-blue-500 to-indigo-600 rounded-lg text-white shadow-lg">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mt-6">
          ...
          <Card className="bg-gradient-to-br from-blue-50 to-indigo-100 border-0 shadow-lg">
            <CardContent className="p-6">
              <div className="flex items-center justify-between">
                <div>
                  <p className="text-sm font-medium text-blue-600">Mevcut Bakiye</p>
          ...
          <Card className="bg-gradient-to-br from-purple-50 to-violet-100 border-0 shadow-lg">
            <CardContent className="p-6">
              <div className="flex items-center justify-between">
                <div>
                  <p className="text-sm font-medium text-purple-600">Hesap Durumu</p>
