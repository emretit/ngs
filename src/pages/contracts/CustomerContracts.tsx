    ...
    <div className="space-y-6">
      ...
      <div className="flex items-center justify-between">
        <div className="flex items-center gap-4">
          ...
          <div className="flex items-center gap-3">
            ...
            <div>
              <h1 className="text-2xl font-bold tracking-tight">Müşteri Sözleşmeleri</h1>
              <p className="text-muted-foreground text-sm">Müşterilerle yapılan satış ve hizmet sözleşmeleri</p>
            </div>
          </div>
        </div>
        <Button>
      ...
      <Tabs defaultValue="all" className="w-full">
        ...
        <TabsContent value="all" className="mt-4">
          <Card>
            <CardHeader>
              <CardTitle>Tüm Müşteri Sözleşmeleri</CardTitle>
              <CardDescription>Müşterilerle yapılan satış ve hizmet sözleşmeleri</CardDescription>
            </CardHeader>
            <CardContent>
              <div className="flex flex-col items-center justify-center py-12 text-center">
                <User className="h-12 w-12 text-muted-foreground mb-4" />
                <h3 className="text-lg font-semibold mb-2">Henüz müşteri sözleşmesi eklenmemiş</h3>
                <p className="text-muted-foreground mb-4">
                  Müşterilerinizle yapılan satış ve hizmet sözleşmelerini takip etmek için yeni bir sözleşme ekleyin.
                </p>
                <Button>
                  <Plus className="h-4 w-4 mr-2" />
                  İlk Sözleşmeyi Ekle
        ...
        <TabsContent value="active" className="mt-4">
          <Card>
            <CardHeader>
              ...
              <CardDescription>Devam eden müşteri sözleşmeleri</CardDescription>
            </CardHeader>
            <CardContent>
