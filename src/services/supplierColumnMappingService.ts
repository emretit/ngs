...
export const mapSupplierColumnsWithAI = async (
  ...
  try {
    ...
    const systemPrompt = `Sen bir veri eşleştirme uzmanısın. Excel dosyasındaki kolon isimlerini, Tedarikçi veritabanı alanlarına eşleştiriyorsun.
...
- Confidence 50'den düşükse eşleştirme yapma`;
    ...
    const userPrompt = `Excel kolonlarını tedarikçi alanlarına eşleştir.`;
